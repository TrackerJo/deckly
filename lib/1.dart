      ...
      return MaterialPageRoute(
        builder:
            (_) => DevicesListScreen(
              ...
              enteredRoomCode: settings.arguments as String? ?? '',
            ),
      );
    case 'advertiser':
      return MaterialPageRoute(
...
class _DevicesListScreenState extends State<DevicesListScreen> {
  ...
  void init() async {
    print("ENTERED ROOM CODE: ${widget.enteredRoomCode}");
    ...
    await nearbyService.init(
      serviceType: 'deckly',
      deviceName: "Deckly-" + devInfo + '-' + _roomCode,
            ...
            devicesList
                .where(
                  (d) =>
                      ...
                      d.deviceName.contains("-${widget.enteredRoomCode}"),
                )
                .toList(),
          );
