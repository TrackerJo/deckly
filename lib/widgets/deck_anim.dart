...
class CardDeckAnimController {
  _CardDeckAnimState? _state;

  void _attach(_CardDeckAnimState state) {
    _state = state;
  }
...
class CardDeckAnim extends StatefulWidget {
  final List<CardData> cards;
  final Function(DragData) onDragStarted;
  final Function() onDragEnd;
  final DragData currentDragData;
  final String deckId;
  final CardDeckAnimController? controller;
  final double scale;
  ...
  @override
  _CardDeckAnimState createState() => _CardDeckAnimState();
}

class _CardDeckAnimState extends State<CardDeckAnim> {
  ...
  @override
  void didUpdateWidget(CardDeckAnim oldWidget) {
